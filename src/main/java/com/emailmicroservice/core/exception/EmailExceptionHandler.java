...
public class EmailExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<DefaultResponse> handleAmazonSimpleEmailServiceException(
            final AmazonSimpleEmailServiceException ex) {
        return new ResponseEntity<>(new DefaultResponse(DefaultResponse.ERROR, Messages.MSG_INVALID_CREDENTIALS),
    ...
    public ResponseEntity<DefaultResponse> handleSdkClientException(final SdkClientException ex) {
        return new ResponseEntity<>(new DefaultResponse(DefaultResponse.ERROR, Messages.MSG_NETWORK),
                HttpStatus.INTERNAL_SERVER_ERROR);
    }
